...
<div class="card">
    <div class="card-header border-bottom">
        <div class="row">
            <div class="col-3">
                <h5 class="card-title mb-3">Mengubah Menu</h5>
            </div>
    ...
    <div class="card-body">
        <div class="mb-3"></div>
        <div class="col-6">
            <form action="{{ route('menu.menu.update', $menu->id) }}" method="post">
                @csrf
                @method('put')
                <div class="mb-3 row">
                    <label for="html5-text-input" class="col-md-2 col-form-label">Nama <span
                            class="text-danger">*</span></label>
                    <div class="col-md-10">
                        <input class="form-control" name="nama" type="text" value="{{$menu->nama}}">
                    </div>
                </div>
                <div class="mb-3 row">
