            ...
            <div class="authentication-inner row">
                ...
                <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
                    <div class="w-px-400 mx-auto">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="bnr-imga animated fadeInRight delay-4 duration-4 text-end">
                                            <img class="img-fluid" src="{{ asset('assets') }}/images/cetar.png"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="bnr-imga animated fadeInRight delay-4 duration-4 text-start">
                                            <img class="img-fluid" src="{{ asset('assets') }}/images/bangkit.png"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <!-- /Logo -->
                        <h3 class="mb-1">Rumah Inovasi</h3>
                        <p class="mb-4">Silahkan masukan email / password anda</p>

                        <form id="formAuthentication" class="mb-3" action="{{ route('rumah-inovasi.postLogin') }}"
                            method="POST">
                            @csrf
                            <div class="mb-3">
